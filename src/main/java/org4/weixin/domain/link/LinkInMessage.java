package org4.weixin.domain.link;
...
public class LinkInMessage extends InMessage{
	...
	public String toString() {
		return "LinkInMessage [title=" + title + ", description=" + description + ", url=" + url + ", getTitle()="
				+ getTitle() + ", getDescription()=" + getDescription() + ", getUrl()=" + getUrl()
