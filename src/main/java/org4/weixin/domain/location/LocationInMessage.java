package org4.weixin.domain.location;
...
public class LocationInMessage extends InMessage{
	...
	public String toString() {
		return "LocationInMessage [location_X=" + location_X + ", location_Y=" + location_Y + ", scale=" + scale
				+ ", label=" + label + ", getLocation_X()=" + getLocation_X() + ", getLocation_Y()=" + getLocation_Y()
				+ ", getScale()=" + getScale() + ", getLabel()=" + getLabel() + ", getToUserName()=" + getToUserName()
